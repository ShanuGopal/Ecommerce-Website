...
function Dashboard_2() {
  return (
    ...
    <img class="h-68 w-full object-cover object-center" src="/13.jpg" alt="Product Image" />
    <div class="p-4">
...
<div class="mx-auto mt-11 w-80 transform overflow-hidden rounded-lg bg-white bg-emerald-600 shadow-md duration-300 hover:scale-105 hover:shadow-lg">
    <img class="h-68 w-full object-cover object-center" src="/15.jpg" alt="Product Image" />
    <div class="p-4">
      <h2 class="mb-2 text-lg font-medium dark:text-white text-gray-900">Product Name</h2>
      <p class="mb-2 text-base dark:text-gray-300 text-gray-700">Product description goes here.</p>
      <div class="flex items-center">
  ...
  <div class="mx-auto mt-11 w-80 transform overflow-hidden rounded-lg bg-white bg-emerald-600 shadow-md duration-300 hover:scale-105 hover:shadow-lg">
  <img class="h-68 w-full object-cover object-center" src="/16.jpg" alt="Product Image" />
  <div class="p-4">
    <h2 class="mb-2 text-lg font-medium dark:text-white text-gray-900">Product Name</h2>
    <p class="mb-2 text-base dark:text-gray-300 text-gray-700">Product description goes here.</p>
    <div class="flex items-center">
...
<div class="mx-auto mt-11 w-80 transform overflow-hidden rounded-lg bg-white bg-emerald-600 shadow-md duration-300 hover:scale-105 hover:shadow-lg">
    <img class="h-68 w-full object-cover object-center" src="/17.jpg" alt="Product Image" />
    <div class="p-4">
      <h2 class="mb-2 text-lg font-medium dark:text-white text-gray-900">Product Name</h2>
      <p class="mb-2 text-base dark:text-gray-300 text-gray-700">Product description goes here.</p>
      <div class="flex items-center">
